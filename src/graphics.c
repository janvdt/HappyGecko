...
static void GRAPHICS_DrawTemperatureSensor(int32_t xoffset, int32_t yoffset, int32_t tempDataSensor);
 ...
 *****************************************************************************/
void GRAPHICS_Draw(int32_t tempData, uint32_t rhData, int32_t tempDataSensor)
{
  GLIB_clear(&glibContext);
    ...
    GRAPHICS_DrawTemperatureSensor(6 , 20, tempDataSensor);
...
static void GRAPHICS_DrawTemperatureSensor(int32_t xoffset, int32_t yoffset, int32_t tempDataSensor)
{
  ...
  GRAPHICS_CreateString(string, tempDataSensor);
  GLIB_drawString(&glibContext, string, strlen(string), xoffset, yoffset, 0);
